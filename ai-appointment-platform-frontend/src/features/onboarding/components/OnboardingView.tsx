      ...
      <div className="relative w-full max-w-md">
        <div className="bg-surface-dark-glass backdrop-blur-xl rounded-2xl shadow-2xl border border-border/30 overflow-hidden">
          <div className="px-8 pt-10 pb-6 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-secondary to-primary text-on-primary mb-6 shadow-lg shadow-primary/30">
          ...
          <div className="px-8 pb-10">
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-secondary to-primary hover:from-secondary hover:to-primary-dark text-on-primary font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/20 disabled:opacity-50"
              >
                {loading ? (
                  <>
