...
export const WaitlistView = ({
  ...
  const sortedEntries = [...filtered].sort(
    (a, b) => ESTADO_ORDER.indexOf(a.estado) - ESTADO_ORDER.indexOf(b.estado),
  );
              ...
              <div className="hidden md:block border border-border rounded-xl overflow-hidden">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-surface-elevated/50">
                    <tr>
                      <th className="py-3 px-4 text-xs font-semibold text-txt-muted uppercase">
                        Cliente
                      </th>
                      <th className="py-3 px-4 text-xs font-semibold text-txt-muted uppercase">
                        Teléfono
                      ...
                      <th className="py-3 px-4 text-xs font-semibold text-txt-muted uppercase text-right">
                        Acciones
                      </th>
                    </tr>
                  </thead>
