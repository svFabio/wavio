...
import { ResumenData } from '../containers/HomeContainer';
          ...
          <div key={stat.label} className="stat-card group">
            <div className="flex items-start justify-between">
              ...
              <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center shadow-lg`}
                style={{ boxShadow: `0 4px 14px -3px ${stat.color === 'primary' ? 'var(--color-primary-glow)' : stat.color === 'warning' ? 'var(--color-warning-glow)' : 'var(--color-success-glow)'}` }}
              >
