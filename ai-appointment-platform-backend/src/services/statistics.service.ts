...
export const getOverview = async (
  ...
  const [
    ...
    statisticsRepository.countCitasMes(negocioId, startOfMonth, endOfMonth),
    statisticsRepository.getCitasConfirmadasMonto(negocioId, startOfMonth, endOfMonth),
    statisticsRepository.getTopClientes(negocioId),
    statisticsRepository.getHorariosPopulares(negocioId),
    statisticsRepository.getRatingPromedio(negocioId),
    statisticsRepository.getUltimosComentarios(negocioId),
    statisticsRepository.countCitasPorOrigen(negocioId, startOfMonth, endOfMonth, 'virtual'),
    statisticsRepository.countCitasPorOrigen(negocioId, startOfMonth, endOfMonth, 'presencial'),
  ]);
