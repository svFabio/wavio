...
export const saveWhatsappCredentials = async (negocioId: number, creds: unknown) => {
...
export const getWhatsappStatus = async (negocioId: number) => {
...
export const disconnectWhatsapp = async (negocioId: number) => {
    await negocioRepository.update(negocioId, {
        waAccessToken: null,
