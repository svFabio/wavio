...
import { ConfiguracionUpdateSchema, QrUploadSchema, UpdateConfiguracionDto, UploadQrDto } from './dto/negocio.dto';
...
export class ConfiguracionController {
  ...
  async updateConfiguracion(@TenantId() negocioId: number, @Body() body: UpdateConfiguracionDto): Promise<unknown> {
  ...
  async uploadQR(@TenantId() negocioId: number, @Body() body: UploadQrDto): Promise<{ qrFotoUrl: string }> {
